    ...
    >
      <Animated.View style={[dc.overlay, { opacity: fadeAnim }]}>
        <Animated.View style={[dc.box, { transform: [{ scale: scaleAnim }] }]}>
          ...
          <Text style={[dc.title, { fontSize: F ? F.lg : 20 }]}>
            Download Resources
          </Text>
          <Text style={[dc.desc, { fontSize: F ? F.xs : 13, fontFamily: SF }]}>
            Choose how you'd like to download campus map data to your device for
            offline use.
          </Text>
          <TouchableOpacity
            style={dc.optionFull}
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text style={[dc.optionTitle, { fontSize: F ? F.md : 15 }]}>
                  Full Download
                </Text>
                <Text
                  style={[
                    dc.optionSub,
                    { fontSize: F ? F.xs - 1 : 11, fontFamily: SF },
                  ]}
                >
          ...
          >
            <View style={dc.optionMetaInner}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={[dc.optionMetaTitle, { fontSize: F ? F.md : 15 }]}>
                  Metadata Only
                </Text>
                <Text
                  style={[
          ...
          >
            <Text
              style={[
                dc.cancelText,
                { fontSize: F ? F.sm : 13, fontFamily: SF },
              ]}
            >
              Cancel
            </Text>
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text style={toast.pct}>
            {isDone ? "Tap to view details" : `${progress}% · tap to expand`}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={toast.closeBtn}
          onPress={onDismiss}
          activeOpacity={0.75}
        >
  ...
  return (
    <View style={ip.wrap}>
      <View style={ip.headerRow}>
        <Animated.View
          style={[ip.iconCircle, { transform: [{ scale: pulseAnim }] }]}
        >
          <LinearGradient
            colors={isDone ? GRAD_GREEN : GRAD_MAROON}
            style={ip.iconGrad}
        ...
        <View style={{ flex: 1, marginLeft: 10 }}>
          ...
          <Text
            style={[
              ip.subtitle,
              { fontSize: F ? F.xs - 1 : 10, fontFamily: SF },
            ]}
            numberOfLines={1}
          >
            {phaseLabel}
      ...
      <View style={ip.barTrack}>
        <Animated.View
          style={[
            ip.barFill,
            { width: barWidth, backgroundColor: isDone ? C.green : undefined },
          ]}
        >
          {!isDone && (
            <LinearGradient
...
const CacheInfoPanel = memo(function CacheInfoPanel({
  ...
  return (
    <Animated.View style={[ci.wrap, { opacity: fadeAnim }]}>
      ...
      <View style={ci.statsGrid}>
        {stats.map((s, i) => (
          <View key={i} style={ci.statCard}>
            ...
            <Text style={[ci.statValue, { fontSize: F ? F.md : 16 }]}>
              {s.value}
            </Text>
            <Text
              style={[
                ci.statLabel,
                { fontSize: F ? F.xs - 2 : 10, fontFamily: SF },
              ]}
            >
              {s.label}
            </Text>
      ...
      <TouchableOpacity
        style={[ci.actionBtn, ci.actionBtnDanger]}
      ...
      >
        <View style={ci.actionBtnInner}>
          ...
          <Text
            style={[
              ci.actionBtnText,
              { fontSize: F ? F.sm : 13, fontFamily: SF, color: C.maroonLight },
            ]}
          >
            Clear Cache
          </Text>
  ...
  const ages = [
    {
      key: "Classic",
      label: "Classic",
      sub: "A balanced, standard display",
      emoji: "⚖️",
    },
    {
      key: "Enhanced",
      label: "Enhanced",
      sub: "Larger text and bolder contrast for easier reading",
      emoji: "🔍",
    },
  ];
    ...
    <View style={s.root}>
      ...
      >
        ...
        >
          ...
          <Text style={s.ageTitle}>
            How do you prefer your reading experience?
          </Text>
          ...
          <View style={s.ageOptions}>
            {ages.map((a) => (
              ...
              >
                ...
                <Text
                  style={[s.ageLabel, selected === a.key && s.ageLabelSelected]}
                >
                  {a.label}
                </Text>
                <Text
  ...
  const types = [
    {
      ...
      label: "Student",
      emoji: "📚",
      desc: "Currently enrolled student",
    },
    {
      key: "teacher",
      label: "Teacher",
      emoji: "🏫",
      desc: "Faculty member / instructor",
    },
    {
      key: "faculty",
      label: "Faculty / Staff",
      emoji: "🏛️",
      desc: "Non-teaching staff member",
    },
      ...
      >
        ...
        >
            ...
            {types.map((t) => (
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text
                    style={[
                      s.typeLabel,
                      { fontSize: F.md },
                      selected === t.key && { color: C.maroon },
                    ]}
                  >
                    {t.label}
                  </Text>
                  <Text
                    style={[s.typeDesc, { fontSize: F.xs, fontFamily: SF }]}
                  >
                    {t.desc}
                  </Text>
                </View>
                <View
                  style={[
                    s.typeRadio,
                    selected === t.key && s.typeRadioSelected,
                  ]}
                >
          ...
          <Text
            style={[
              s.hintText,
              { fontSize: F.xs, textAlign: "center", fontFamily: SF },
            ]}
          >
...
const NodePickerModal = memo(function NodePickerModal({
  ...
  const filtered = useMemo(() => {
    ...
    return NODES_SEARCHABLE.filter(
      (n) =>
        n._room.includes(q) || n._building.includes(q) || n._floor.includes(q),
    );
  }, [debouncedQuery]);
  ...
  const getItemLayout = useCallback(
    (_, index) => ({
      length: NODE_ITEM_HEIGHT,
      offset: NODE_ITEM_HEIGHT * index,
      index,
    }),
    [],
  );
        ...
        <View style={nm.nodeInfo}>
          ...
          <View style={nm.nodeMeta}>
            <View style={nm.nodeMetaBadge}>
              <Text style={[nm.nodeMetaText, { fontSize: F.xs }]}>
                {item.floor}
              </Text>
            </View>
            <Text style={[nm.nodeMetaSep, { fontSize: F.xs }]}>·</Text>
            <Text
              style={[nm.nodeBuilding, { fontSize: F.xs, fontFamily: SF }]}
              numberOfLines={1}
            >
              {item.building}
            </Text>
      ...
      <View style={sm.root}>
        ...
        >
          ...
          <View style={sm.section}>
            <Text style={[sm.sectionTitle, { fontSize: F.sm }]}>
              360° Image Quality
            </Text>
              ...
              >
                <Text
                  style={[
                    sm.qualityBtnText,
                    { fontSize: F.sm },
                    !hdQuality && sm.qualityBtnTextActive,
                  ]}
                >
                  SD
                </Text>
          ...
          <View style={sm.section}>
            <View style={sm.settingRow}>
              <View style={{ flex: 1 }}>
                <Text style={[sm.settingLabel, { fontSize: F.md }]}>
                  Force Offline Mode
                </Text>
                <Text
                  style={[sm.settingDesc, { fontSize: F.xs, fontFamily: SF }]}
                >
...
function HomeScreen({ ageRange, userType, onBack }) {
  ...
  const selectStart = useCallback((node) => {
    setStartNode(node);
    setShowStartPicker(false);
  }, []);
  const selectDest = useCallback((node) => {
    setDestNode(node);
          ...
          >
            ...
            <View style={h.card}>
              <View style={h.cardLabel}>
                ...
                <Text style={[h.cardLabelText, { fontSize: F.xs }]}>
                  Route Planner
                </Text>
              ...
              >
                ...
                >
                  <View style={h.inputBtnInner}>
                    <Text style={[h.inputBtnLabel, { fontSize: F.sm }]}>
                      Starting Point
                    </Text>
                    <Text
                      style={[
              ...
              >
                ...
                >
                  <View style={h.inputBtnInner}>
                    <Text style={[h.inputBtnLabel, { fontSize: F.xs }]}>
                      Destination Point
                    </Text>
                    <Text
                      style={[
...
export default function App() {
  ...
  const goToType = useCallback((age) => {
    setAgeRange(age);
    setScreen("type");
  }, []);
  const goToHome = useCallback((type) => {
    setUserType(type);
    setScreen("home");
  }, []);
  ...
  return (
    <HomeScreen ageRange={ageRange} userType={userType} onBack={goBackType} />
  );
}
...
const nm = StyleSheet.create({
  ...
  nodeMetaSep: { color: C.black, fontSize: 10 },
  nodeBuilding: {
    fontFamily: "Montserrat_400Regular",
    fontSize: 10.5,
    color: C.charcoal,
...
const sm = StyleSheet.create({
  ...
  cancelDlBtn: {
    ...
    borderRadius: 10,
    borderWidth: 1.5,
    borderColor: "rgba(176,48,69,0.3)",
    backgroundColor: "rgba(176,48,69,0.05)",
    alignItems: "center",
  },
  cancelDlText: {
    fontFamily: "Montserrat_600SemiBold",
...
const dc = StyleSheet.create({
  overlay: {
    flex: 1,
    backgroundColor: "rgba(10,0,5,0.62)",
    alignItems: "center",
    justifyContent: "center",
...
const ip = StyleSheet.create({
  ...
  barTrack: {
    height: 6,
    borderRadius: 3,
    backgroundColor: "rgba(107,15,26,0.12)",
    overflow: "hidden",
    marginBottom: 12,
  },
...
const ci = StyleSheet.create({
  ...
  actionBtnDanger: {
    borderColor: "rgba(176,48,69,0.3)",
    backgroundColor: "rgba(176,48,69,0.04)",
  },
  actionBtnInner: {
    flexDirection: "row",
    alignItems: "center",
